...
No Orchid-specific graph API — standard OpenAI-style chat completions under the hood. If you need the **Anthropic Messages** wire format, use [`/v1/messages`](/api-reference/messages); for **Claude Code**, see [Claude Code](/integrations/claude-code) instead of `ChatOpenAI`.
