...
No Orchid-specific graph API — standard OpenAI-style chat completions under the hood. If you need the **Anthropic Messages** wire format or **Claude Code** routing, use the [Anthropic SDK](/integrations/anthropic) against [`/v1/messages`](/api-reference/messages) instead of `ChatOpenAI`.
