...
For **Claude Code** or other flows that expect the Anthropic **Messages** API, use the [Anthropic SDK integration](/integrations/anthropic) with **`/v1/messages`** instead of Cursor’s OpenAI override.
